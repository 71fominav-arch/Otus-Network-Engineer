...
S*    0.0.0.0/0 [1/0] via 10.0.20.34  /* Вариант c ecmp, трафик распределяется между двумя провайдерами. Хороший вариант только с Nat, иначе возможен вариант когда трафик исходящий идет через один интерфейс, входящий через другой.                       
                [1/0] via 10.0.20.14                 
